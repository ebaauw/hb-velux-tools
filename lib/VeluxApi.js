...
const commands = Object.freeze({
  ...
  GW_NEW_GROUP_REQ: { // 8.4.4 - Request new group to be created.
    ...
    encode: (params, userInput = false) => {
      ...
      // data.writeUint8(type, 69) // 0: user, 1: room, 2: house, 3: all - only user seems to work
  ...
  GW_SET_GROUP_INFORMATION_REQ: { // 8.4.6 - Change an existing group.
    ...
    encode: (params, userInput = false) => {
      ...
      // data.writeUint8(type, 70) // 0: user, 1: room, 2: house, 3: all - only user seems to work
